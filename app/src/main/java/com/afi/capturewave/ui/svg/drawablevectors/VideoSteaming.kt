package com.afi.capturewave.ui.svg.drawablevectors
...
import com.afi.capturewave.ui.svg.DynamicColorImageVectors

@Composable
fun DynamicColorImageVectors.videoSteaming(): ImageVector {
    return Builder(
        name = "VideoSteaming", defaultWidth = 766.0.dp, defaultHeight =
        663.78.dp, viewportWidth = 766.0f, viewportHeight = 663.78f
    ).apply {
        path(
            fill = SolidColor(MaterialTheme.colorScheme.surfaceContainerHighest), stroke = null, strokeLineWidth = 0.0f,
        ...
        path(
            fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.14f, strokeAlpha
            = 0.14f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.tertiaryContainer), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.surfaceVariant), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.primary), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.onPrimary), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
