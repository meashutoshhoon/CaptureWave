...
fun DynamicColorImageVectors.videoFiles(): ImageVector {
    return Builder(
        name = "VideoFiles", defaultWidth = 1008.9205.dp, defaultHeight =
        607.45.dp, viewportWidth = 1008.9205f, viewportHeight = 607.45f
    ).apply {
        path(
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.outline), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
