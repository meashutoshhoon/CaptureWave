...
fun DynamicColorImageVectors.coder(): ImageVector {
    return Builder(
        name = "Coder", defaultWidth = 717.67004.dp, defaultHeight = 453.96432.dp,
        viewportWidth = 717.67004f, viewportHeight = 453.96432f
    ).apply {
        path(
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.surfaceContainer), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
        ...
        path(
            fill = SolidColor(MaterialTheme.colorScheme.inversePrimary), stroke = null, strokeLineWidth = 0.0f,
            strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            pathFillType = NonZero
        ) {
